...
class DataCollector:
    ...
    def get_data(
        ...
        for actor_id, id in id_map.items():
            ...
            health_point = Simulator.get_actor_health(id)
            ammo_left = Simulator.get_actor_ammo(id)
            fire_angle = Simulator.get_actor_fire_angle(id)
            fire_angle_range = Simulator.get_actor_fire_angle_range(id)
            ...
            measurements[actor_id] = Measurement(
                ...
                fire_angle_range=fire_angle_range,
                waypoint=waypoint,
