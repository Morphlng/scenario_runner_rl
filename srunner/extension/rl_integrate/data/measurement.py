...
class Measurement:
    ...
    health_point: float = 100.0
    """Health point of the actor"""

    ammo_left: int = 0
    """Ammo left for the actor's weapon"""

    fire_angle: FireAngle = None
    """Fire angle of the actor's weapon now"""

    fire_angle_range: FireAngleRange = None
    """Fire angle range of the actor's weapon"""
